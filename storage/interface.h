...
typedef struct __S_SUB__ {
    ...
    char *path_pattern; /* Wildmat pattern to check against the Path header
                           field to determine if the article should go to this
                           method.  NULL if any path should match. */
