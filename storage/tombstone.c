...
**
**  See include/inn/tombstone.h for the API and inn.conf.pod under
**  "expiretombstone" for the file semantics.  Shared between the
**  expire binary and the test suite so both exercise identical
