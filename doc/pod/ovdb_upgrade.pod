...
Do a C<make clean> in the INN source tree
...
Do a C<make update> to build INN with the new BerkeleyDB version and install
the new binaries.

=item 6

Run C<ovdb_upgrade> as the news user.
