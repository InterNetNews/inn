...
The B<libauth> and B<libstorage> libraries have been renamed to B<libinnauth>
and B<libinnstorage> to homogenize their name with existing B<libinnhist>.
External programs linking against them need a manual change.
