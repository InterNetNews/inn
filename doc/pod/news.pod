...
present in cancel articles was not useful in B<innd> (it is relevant to
posting agents).
...
permits determining whether the hash, when generated, is based on the username
or the (static) IP of the connection.
