=head1 Changes from 2.3.2 to 2.3.3 (in progress)
...
An off-by-one bug in repacking overview index files and a reliability bug
with writing overview data were both fixed in the tradindexed overview
