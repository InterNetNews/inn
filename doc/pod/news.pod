...
parsing, bounded parsing of overview records during expiration, validation of
corrupt OVDB records and search handles, reserved file descriptor management,
and hexadecimal and uuencoded data handling.  Reader tracking and virtualhost
permission state, batch error cleanup, and file-list growth in expiration
tools were also corrected.  Many thanks to Kevin Bowling for the patches.
