...
I<pathdb> (they are expiry state, not history files).  Separating history
is especially useful with hissqlite on ZFS, where the dataset I<recordsize>
should match the SQLite page size; see hissqlite(5).  Thanks to Kevin Bowling
for this feature.
