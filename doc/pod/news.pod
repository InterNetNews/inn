...
into the right place.  The easiest way to do this is to, on your old
server, generate a list of all of your existing article files and then
feed that list to innxmit.
