...
RSA signatures used by most current control message senders.  You need to
install both GnuPG and pgpgpg from <http://www.gnupg.org/>; a link for
pgpgpg is under "Front ends."
