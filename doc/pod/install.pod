...
Perl, see <http://www.perl.com/pub/language/info/software.html>.
...
RSA signatures used by most current control message senders.
...
Finally, there is a special entry for controlchan for processing newsgroup
control messages that should always be in F<newsfeeds> unless you never
want to honor any newsgroup control messages.  This entry should look
like:
