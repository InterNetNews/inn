...
nntpsend; see the man page for F<nntpsend.ctl> for more information.
...
sample newsfeeds file, making sure the path is correct.  See
L<Processing Control Messages> for more details.
