...
so that you can distribute the individual cycbuffs across multiple
physical disks and balance the load between them.
...
this, FreeBSD and Linux do not.  Also on many PC-based Unixes it is
difficult to create more than eight partitions, which may limit your
options.  See L<Creating the Article Spool> for more discussion of how to
set this up.
