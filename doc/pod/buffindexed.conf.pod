...
than that constraint, it can be any number between 0 and 32767 (it is
internally stored as a signed 16-bit integer).
...
as to minimize the duration of the B<expireover> process, and to just
