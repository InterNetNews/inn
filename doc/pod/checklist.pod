...
be commented if you do not want to add a default Organization header field
to every post from your server), your path in I<pathhost> (usually your
...
spool.  The default of 15 days is probably too short.  You can use different
values for specific newsgroups or hierarchies depending on your interest in
them.
