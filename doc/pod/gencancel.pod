...
reuse that information for the cancel control message.  If you want to modify
...
If, for whatever reason, you need to cancel an article posted from your news
...
output.  You can then reuse it for instance in a supersede request or from
another script.
