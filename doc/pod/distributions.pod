...
for posters who wish to add a Distribution header field to their articles
...
information about how a news server handles the Distribution header field.
...
Any client that issues the LIST DISTRIBUTIONS command obtains these
...
The Distribution header field can also be automatically set by B<nnrpd>
