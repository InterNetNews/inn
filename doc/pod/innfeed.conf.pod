...
You can reload this configuration file with the following command which makes
B<innd> respawn a new instance of B<innfeed> (assuming C<innfeed!> is the name
of the corresponding channel feed in F<newsfeeds>):
