...
field body, provided the first site name in the Path header field
body is different from the local one.  In addition, I<pathalias> and
I<pathcluster> may be similarly respectively prepended and appended to
the Path header field body; see inn.conf(5) for the details.
...
innbind(8), inndcomm(3), innfeed(8), innstat(8), newsfeeds(5), nnrpd(8),
rnews(1), syslog(3).
