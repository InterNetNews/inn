...
When this type is used, the line consists of only two fields.  The default
...
One of the differences between a B<doit> or B<verify> action and a B<mail>
...
Then, as F<control.ctl> is processed from the bottom, here is what happens:
...
to decode the sentence as CP1252 and re-encode it as UTF-8.
