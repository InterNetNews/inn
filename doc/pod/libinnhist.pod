...
is normall passed as B<true>, if you wish to inhibit writing of the
...
server the I<reason> string is used as an an argument to the `ctlinnd
...
setting an error, call libinn's B<warn> function.
