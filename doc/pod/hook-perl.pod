...
Note that the value of C<$hdr{Lines}> is the body of the Lines header
field of the article and may bear no resemblence to the actual length
of the article.  C<$hdr{__LINES__}> is the line count calculated by INN,
