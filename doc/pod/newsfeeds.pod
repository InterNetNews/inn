...
A minimalist F<newsfeeds> file which parameters an outgoing feed to
C<news.server.com>, using feed path entry C<server>, of all the articles you
receive is:
...
Here's a more esoteric example of a channel feed:
    ...
    watcher!:*:Tc,Wbnm\
        :exec awk '$1 > 1000000 { print "BIG", $2, $3 }' >> <pathlog>/bigart
