...
handled according to the above rules.  If any of the specified
...
The time the article was posted as seconds since epoch.
...
C<sue@example.com>, both of which funnel into C<mailer!>, so it will look
