...
Whether to enable the tracking system for client posting.  What is
tracked is posted article itself, and written to
I<patharticles>/Message-ID.  Which user and client, that is recorded,
is determined by nnrpd.track.  See nnrpd.track(5) for more information.
This is a boolean value and the default is false.
