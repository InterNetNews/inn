...
This work is sponsored by the Internet Systems Consortium.
...
INN is free software, supported by the Internet Systems Consortium and
...
Note that INN is supported by the Internet Systems Consortium, and
...
money to produce.  That money comes from ISPs, hardware and software
vendors, companies who make extensive use of the software, and generally
kind-hearted folk such as yourself.

The Internet Systems Consortium has also commissioned a DHCP server
