...
# This program is modified from the original libtool script to support
# the three options -O, -G and -b that are used by installit.sh in the
# INN system.  It is otherwise identical.
